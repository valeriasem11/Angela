...
# deepseek-v4-flash — дешёвая и быстрая модель (18₽/36₽ за 1M токенов),
# хорошо подходит для чат-бота. Название должно точно совпадать со
# значением в разделе "Разрешённые модели" настроек ключа AITUNNEL —
